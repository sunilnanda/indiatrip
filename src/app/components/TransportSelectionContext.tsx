...
import { TransportOption, itinerary, delhiToJalandharTransport, delhiToChandigarhTransport, flexiblePlans } from "../data";
...
function findOptions(legId: string): TransportOption[] | undefined {
  ...
  if (legId === "delhi-chandigarh") return delhiToChandigarhTransport;
